...
2. Bağımlılıkları yükleyin:
   ...
   ```
3. Ortam değişkenlerini yapılandırın (aşağıdaki "Ortam Değişkenleri" bölümüne bakın).
...
- Tokenlar `SharedPreferences` içinde `quiz_app_prefs` altında `access_token` olarak saklanır.
